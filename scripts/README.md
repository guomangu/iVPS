...
| [`03_configure.sh`](file:///home/gamo/Documents/ivps/scripts/03_configure.sh) | Configure Cockpit (`/etc/cockpit/cockpit.conf`) pour le reverse proxy et ouvre le pare-feu. |
